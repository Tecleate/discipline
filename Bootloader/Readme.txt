...
In-Circuit que se que se conecta a la cabecera de pines ICSP del Discipline,
...
- El archivo "USBaspLoader.hex" específico del Discipline.


PROCEDIMIENTO PARA FLASHEAR EL BOOTLOADER
=========================================
1) Instalar correctamente los drivers proporcionados con el programador ICSP.
2) Conectar el programador a la cabecera de 6 pines ICSP del Discipline
...
5) En el apartado "Bitclock" seleccionar 16KHz si el teclado tiene un ATmega32A
   de fábrica o 1.5MHz si tiene un ATmega pre-configurado.
6) En el apartado "Flash" buscar el archivo "USBaspLoader.hex" del Discipline.
...
2) Conectar el Discipline al PC manteniendo pulsado el botón "Boot".
...
MÁS INFORMACIÓN
===============
Código fuente del USBaspLoader para el ATmega32A:
